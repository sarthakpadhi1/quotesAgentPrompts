...
Return: {
  ...
  "type": "interactive",
  "enum_helper": "cvSubCategory: PCV_TAXI"
}
```
...
Agent returns: {"is_done": true, "enum_helper": "policyType: od, prevPolicyInsurer: NAVI, cvSubCategory: PCV_AUTO, idv: 650000"}
```
...
```json
{
  ...
  "enum_helper": "field1: value1, field2: value2"
}
```
...
// Multiple choice
{
  ...
  "type": "interactive",
  "enum_helper": "cvSubCategory: PCV_CORPORATE_BUS"
}
...
// Completion
{
  ...
  "options": null,
  "type": "text",
  "enum_helper": "policyType: ThirdParty, prevPolicyInsurer: LIBERTY, cvSubCategory: MISCD_HEARSE, registrationDate: 2021-03-10"
}
```
...
```json
{
  "enum_helper": "prevPolicyInsurer: KOTAK"
}
```
...
```json
{
  "enum_helper": "policyType: Comprehensive, prevPolicyInsurer: ROYALSUNDARAM, cvSubCategory: MISCD_TRAILER_AGRI_TRACTOR_6HP, idv: 920000, registrationDate: 2018-11-05, makeModel: MAHINDRA_BOLERO"
}
```
...
STEP 3: Use SAME IDENTICAL string in enum_helper field
```
...
5. **When all fields satisfied** (`required = False` for all):
   ...
   - Return `is_done = True` with SAME enum string in `enum_helper`
...
Return: {
  ...
  "options": null,
  "type": "text",
  "enum_helper": "registrationDate: 2020-07-15"
}
```
...
Return: {
  ...
  "type": "interactive",
  "enum_helper": "cvSubCategory: MISCD_AGRI_TRACTOR_ABOVE_6HP"
}
...
Return: {
  ...
  "type": "interactive",
  "enum_helper": "prevPolicyInsurer: NTNL"
}
```
...
Return: {"is_done": true, "enum_helper": "prevPolicyInsurer: UNTD, cvSubCategory: PCV_SCHOOL_BUS, policyType: Comprehensive, idv: 1500000, registrationDate: 2019-05-01"}
```
...
- ✅ Return complete `enum_helper` when `is_done = true`
...
- ❌ Return partial `enum_helper` when complete
...
6. Complete `enum_helper` when `is_done = true`
...
5. Returning partial `enum_helper`
